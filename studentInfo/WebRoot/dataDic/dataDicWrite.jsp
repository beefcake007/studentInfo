		...
		<form action="dataDic!save" method="post" onsubmit="return checkForm()">
			<table width="40%" align="center" style="border-collapse:separate; border-spacing:5px 15px;">
				<tr>
					...
					<td>
						<select id="ddTypeId" name="dataDic.ddTypeId" class="form-control">
				...
				<tr>
					...
					<td><input type="text" id="ddValue" name="dataDic.ddValue" class="form-control" value="${dataDic.ddValue }"></td>
				</tr>
				<tr>
					<td valign="top"><label>数据字典描述：</label></td>
					<td>
						<textarea rows="5" cols="22" id="ddDesc" name="dataDic.ddDesc" class="form-control">${dataDic.ddDesc}</textarea>
					</td>
				</tr>
				<tr>
					<td>
						<input type="hidden" id="ddId" name="dataDic.ddId" value="${dataDic.ddId }">
